...
interface CreateNewPlanItemModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (newSubject: PlanItem) => void;
}

const CreateNewPlanItemModal: React.FC<CreateNewPlanItemModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
}) => {
...
export default CreateNewPlanItemModal;
