...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden pt-8 md:pt-16">
      {/* Hero Section */}
      <motion.section
        ref={heroRef}
        animate={isHeroInView ? "visible" : "hidden"}
        className="relative flex flex-col items-center justify-center gap-6 py-12 md:py-20 lg:py-32 text-center bg-cover bg-center px-4"
        custom={0}
        initial="hidden"
      ...
      >
        ...
        <motion.h1
          className="relative z-10 text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight drop-shadow-2xl"
          custom={1}
          variants={fadeInVariants}
        >
        ...
        <motion.p
          className="relative z-10 text-lg sm:text-xl md:text-2xl max-w-xl md:max-w-3xl font-light tracking-wide text-gray-300 px-2"
          custom={2}
          variants={fadeInVariants}
        >
        ...
        >
          <Link
            className={buttonStyles({
              ...
              size: "lg",
              className:
                "bg-cyan-500 hover:bg-cyan-600 hover:scale-105 transition-all duration-300 shadow-lg shadow-cyan-500/40 px-6 sm:px-8 py-2",
            })}
          ...
          <Link
            className={buttonStyles({
              ...
              size: "lg",
              className:
                "border-cyan-400 text-cyan-400 hover:bg-cyan-400/20 hover:border-cyan-300 transition-all duration-300 px-6 sm:px-8 py-2",
            })}
      ...
      <motion.section
        ...
        className="py-16 md:py-24 bg-gray-950 relative px-4"
        custom={0}
        initial="hidden"
        variants={fadeInVariants}
      >
        <div className="max-w-full sm:max-w-4xl md:max-w-6xl mx-auto text-center">
          <motion.h2
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 tracking-tight"
            custom={1}
            variants={fadeInVariants}
          >
          ...
          >
            ...
            />
            <motion.p
              className="mt-4 md:mt-6 text-gray-400 font-light text-base sm:text-lg"
              custom={3}
              variants={fadeInVariants}
            >
      ...
      <motion.section
        ...
        className="py-16 md:py-24 bg-black relative px-4"
        custom={0}
        initial="hidden"
        variants={fadeInVariants}
      >
        ...
        <div className="max-w-full sm:max-w-4xl md:max-w-6xl mx-auto relative z-10">
          <motion.h2
            className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-12 md:mb-16 tracking-tight"
            custom={1}
            variants={fadeInVariants}
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12">
            <motion.div
              className="group p-6 md:p-8 bg-gray-900/80 rounded-2xl hover:bg-gray-900 hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-500"
              custom={2}
              variants={fadeInVariants}
            >
              <img
                alt="Lịch học thông minh"
                className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 md:mb-6 opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300"
      ...
      <motion.section
        ...
        className="py-20 md:py-28 bg-gradient-to-br from-gray-900 to-cyan-900/40 relative px-4"
        custom={0}
        initial="hidden"
        variants={fadeInVariants}
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 md:gap-10 text-center">
          <motion.img
            alt="Công nghệ học tập"
            className="w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 object-contain opacity-85 hover:opacity-100 hover:scale-105 transition-all duration-500"
            custom={1}
          ...
          <motion.div custom={3} variants={fadeInVariants}>
            <Link
              className={buttonStyles({
                ...
                size: "lg",
                className:
                  "bg-cyan-500 hover:bg-cyan-600 hover:scale-105 transition-all duration-300 shadow-2xl shadow-cyan-500/50 px-8 md:px-10 py-3 md:py-5 text-lg md:text-xl",
              })}
              href={siteConfig.links.register}
            >
              Bắt Đầu Miễn Phí
